  ...
  const steps = [
    {
      ...
      description: "Land in a new city? Open Kyro to discover partner gyms near you.",
    },
    {
      icon: <Building2 className="h-8 w-8" />,
      step: "02",
      title: "Pick Your Gym",
      description: "Browse photos, amenities and reviews. Choose the gym that fits your workout and route.",
    },
    {
      icon: <Dumbbell className="h-8 w-8" />,
      step: "03",
      title: "Start Training",
      description: "Buy your pass, show your digital access at the gym and get your workout in. Simple.",
    },
  ];
